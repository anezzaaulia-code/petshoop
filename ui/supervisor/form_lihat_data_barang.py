...
class Ui_MainWindow(object):
        def setupUi(self, MainWindow):
                ...
                self.label.setText("Lihat Data Produk")
                ...
                self.label_total.setText("Total Produk: 0")
                ...
                self.lineEdit.setPlaceholderText("Cari nama produk...")
        ...
        def load_data(self):
                data = Produk.select_all()
                self.set_table(data)
                self.label_total.setText(f"Total Barang: {len(data)}")
        ...
        def set_table(self, data):
                ...
                ["ID", "Nama", "Harga", "Stok", "Jenis Hewan", "Kategori"]
                )
                ...
                # ================================================================
        def back(self):
                from dashboard.dashboard_supervisor import Ui_MainWindow
